...
with tab_live:
    ...
    if not daily_df.empty:
        ...
        # Dummy trace for legend (invisible, sets legend color to green)
        ...
        # Actual Total bar with dynamic colors (green/red per bar), but hidden from legend
        fig.add_trace(go.Bar(
        ...
        # Add only real strategy columns (from strategies table)
