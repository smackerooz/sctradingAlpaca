...
with st.sidebar:
    ...
    st.caption("Bot is running on Railway — start/stop from Railway dashboard.")
...
# ── Dashboard note ──────────────────────────────────────────────────────────
st.info("👁️ **DASHBOARD MODE** — Bot is running autonomously on Railway. This is a view-only dashboard.", icon="🤖")
...
# ─────────────────────────────────────────────
# 10. AUTO-REFRESH (dashboard only — bot runs separately on Railway)
# ─────────────────────────────────────────────
